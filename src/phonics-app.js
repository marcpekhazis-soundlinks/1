const WORDS = [
  ...
  // ---------- 'ai' sound group ----------
  // From the manuscript's "ai" chapter. No `image`/`svg` yet — real DALL-E
  ...
  // 'ai' tab purely because its spelling contains "ai", so no other wiring
  // is needed for the sidebar, tiers, level-locking, badges, Roll and
  // Read, Word Search, or Reading Activity.
  { word: 'ail', arabic: 'مَرَضٌ / يُؤْلِمُ', hint: 'to cause pain or trouble to someone', visual: 'ail', level: 1, sentence: "A toothache can really ail you." },
  { word: 'aim', arabic: 'هَدَفٌ / يَسْتَهْدِفُ', hint: 'to point or direct something at a target', visual: 'aim', level: 1, sentence: "Take careful aim before you shoot the arrow." },
  { word: 'air', arabic: 'هَوَاءٌ', hint: 'the invisible gas we breathe', visual: 'air', level: 1, sentence: "She opened the window for fresh air." },
  { word: 'bail', arabic: 'كَفَالَةٌ / يُفْرِجُ بِالكَفَالَةِ', hint: 'money paid to release someone from jail', visual: 'bail', level: 1, sentence: "His family paid the bail to set him free." },
  { word: 'bait', arabic: 'طُعْمٌ', hint: 'food used to catch fish or animals', visual: 'bait', level: 1, sentence: "He put a worm on the hook as bait." },
  { word: 'fail', arabic: 'يَفْشَلُ', hint: 'to not succeed at something', visual: 'fail', level: 1, sentence: "Study hard so you don't fail the test." },
  { word: 'fair', arabic: 'عَادِلٌ / مَعْرِضٌ', hint: 'treating everyone equally; or a carnival', visual: 'fair', level: 1, sentence: "The judge tried to be fair to both sides." },
  // fain: archaic word meaning "gladly, willingly" — kept as-is from the manuscript.
  { word: 'fain', arabic: 'رَاغِبٌ / بِسُرُورٍ', hint: 'an old word meaning gladly or willingly', visual: 'fain', level: 1, sentence: "He would fain accept the invitation." },
  { word: 'gain', arabic: 'يَكْسِبُ / مَكْسَبٌ', hint: 'to get more of something', visual: 'gain', level: 1, sentence: "Regular exercise can help you gain strength." },
  { word: 'hail', arabic: 'بَرَدٌ / يُحَيِّي', hint: 'small balls of ice that fall like rain', visual: 'hail', level: 1, sentence: "Hard little balls of hail fell during the storm." },
  { word: 'jail', arabic: 'سِجْنٌ', hint: 'a place where people are locked up', visual: 'jail', level: 1, sentence: "The thief was sent to jail." },
  { word: 'mail', arabic: 'بَرِيدٌ', hint: 'letters and packages sent through the post', visual: 'mail', level: 1, sentence: "I checked the mailbox for new mail." },
  { word: 'maid', arabic: 'خَادِمَةٌ', hint: 'a woman who cleans a house', visual: 'maid', level: 1, sentence: "The maid tidied every room in the house." },
  { word: 'nail', arabic: 'ظُفْرٌ / مِسْمَارٌ', hint: 'a metal spike, or the hard tip on a finger', visual: 'nail', level: 1, sentence: "He used a hammer to drive the nail into the wood." },
  { word: 'pail', arabic: 'دَلْوٌ', hint: 'a bucket used to carry water or sand', visual: 'pail', level: 1, sentence: "The children filled the pail with sand." },
  { word: 'paid', arabic: 'مَدْفُوعٌ', hint: 'past tense of pay', visual: 'paid', level: 1, sentence: "She paid for the groceries with cash." },
  { word: 'pain', arabic: 'أَلَمٌ', hint: 'an uncomfortable feeling caused by injury', visual: 'pain', level: 1, sentence: "He felt a sharp pain in his knee." },
  { word: 'pair', arabic: 'زَوْجٌ / يُزَاوِجُ', hint: 'two things that go together', visual: 'pair', level: 1, sentence: "She bought a new pair of shoes." },
  { word: 'raid', arabic: 'غَارَةٌ', hint: 'a sudden attack or surprise search', visual: 'raid', level: 1, sentence: "Police carried out a raid on the warehouse." },
  { word: 'rail', arabic: 'سِكَّةٌ حَدِيدِيَّةٌ / حَاجِزٌ', hint: 'a bar used as a track or fence', visual: 'rail', level: 1, sentence: "The train sped down the steel rail." },
  { word: 'rain', arabic: 'مَطَرٌ', hint: 'water falling from clouds', visual: 'rain', level: 1, sentence: "We stayed inside because of the rain." },
  { word: 'sail', arabic: 'شِرَاعٌ / يُبْحِرُ', hint: 'the cloth that catches wind on a boat', visual: 'sail', level: 1, sentence: "The boat's white sail filled with wind." },
  { word: 'tail', arabic: 'ذَيْلٌ', hint: "the part at the back of an animal's body", visual: 'tail', level: 1, sentence: "The dog wagged its tail happily." },
  // vail: archaic word meaning "to lower (e.g. a hat) as a sign of respect".
  { word: 'vail', arabic: 'يُنْزِلُ / يَتَنَحَّى', hint: 'an old word meaning to lower or give way', visual: 'vail', level: 1, sentence: "The knight would vail his hat to the queen." },
  { word: 'wail', arabic: 'يَنْدُبُ / وَلْوَلَةٌ', hint: 'a long, loud cry of pain or sadness', visual: 'wail', level: 1, sentence: "The baby began to wail in the night." },
  { word: 'wait', arabic: 'يَنْتَظِرُ', hint: 'to stay in one place until something happens', visual: 'wait', level: 1, sentence: "Please wait for me by the door." },
  { word: 'await', arabic: 'يَنْتَظِرُ', hint: 'to wait for something to happen', visual: 'await', level: 1, sentence: "We eagerly await the start of summer vacation." },
  { word: 'brain', arabic: 'دِمَاغٌ / عَقْلٌ', hint: 'the organ inside your head that lets you think', visual: 'brain', level: 1, sentence: "Your brain controls everything your body does." },
  { word: 'chain', arabic: 'سِلْسِلَةٌ', hint: 'a series of connected metal rings', visual: 'chain', level: 1, sentence: "The dog was tied up with a chain." },
  { word: 'claim', arabic: 'يُطَالِبُ / مَطْلَبٌ', hint: 'to say something is true, or to ask for something owed', visual: 'claim', level: 1, sentence: "She will claim her prize at the front desk." },
  { word: 'drain', arabic: 'يُصَرِّفُ / مَصْرَفٌ', hint: 'a pipe that carries water away', visual: 'drain', level: 1, sentence: "Leaves clogged the drain outside the house." },
  { word: 'flair', arabic: 'أُسْلُوبٌ مُتَمَيِّزٌ', hint: 'a natural talent or stylish way of doing things', visual: 'flair', level: 1, sentence: "She decorated the room with real flair." },
  { word: 'flail', arabic: 'يُلَوِّحُ / ضَرْبَةٌ', hint: 'to wave or swing wildly', visual: 'flail', level: 1, sentence: "He began to flail his arms in the pool." },
  { word: 'grain', arabic: 'حَبَّةٌ / حُبُوبٌ', hint: 'a tiny seed of wheat, rice, or other cereal', visual: 'grain', level: 1, sentence: "The farmer stored the grain in a tall silo." },
  { word: 'paint', arabic: 'طِلَاءٌ / يَدْهُنُ', hint: 'colored liquid used to cover a surface', visual: 'paint', level: 1, sentence: "We used blue paint to cover the fence." },
  { word: 'plaid', arabic: 'قُمَاشٌ مُقَلَّمٌ', hint: 'a pattern of crossing colored stripes', visual: 'plaid', level: 1, sentence: "He wore a red and black plaid shirt." },
  { word: 'plain', arabic: 'سَهْلٌ / بَسِيطٌ', hint: 'simple, with nothing added; or a flat area of land', visual: 'plain', level: 1, sentence: "She wore a plain white dress." },
  { word: 'quail', arabic: 'سُمَانَى (طَائِرٌ)', hint: 'a small, round game bird', visual: 'quail', level: 1, sentence: "A quail scurried through the tall grass." },
  { word: 'raise', arabic: 'يَرْفَعُ', hint: 'to lift something up', visual: 'raise', level: 1, sentence: "Please raise your hand if you know the answer." },
  { word: 'saint', arabic: 'قِدِّيسٌ', hint: 'a person known for great goodness or holiness', visual: 'saint', level: 1, sentence: "The church was named after a famous saint." },
  { word: 'snail', arabic: 'حَلَزُونٌ', hint: 'a small, slow creature with a spiral shell', visual: 'snail', level: 1, sentence: "A tiny snail crawled across the leaf." },
  { word: 'stain', arabic: 'بُقْعَةٌ', hint: 'a mark that is hard to remove', visual: 'stain', level: 1, sentence: "She spilled juice and left a stain on the rug." },
  { word: 'trait', arabic: 'صِفَةٌ', hint: 'a quality or characteristic of someone', visual: 'trait', level: 1, sentence: "Kindness is her best trait." },
  { word: 'train', arabic: 'قِطَارٌ / يُدَرِّبُ', hint: 'a line of connected railway cars; or to teach', visual: 'train', level: 1, sentence: "We rode the train into the city." },
  { word: 'trail', arabic: 'مَمَرٌّ / يَتْبَعُ', hint: 'a path through the woods or hills', visual: 'trail', level: 1, sentence: "We hiked along the mountain trail." },
  { word: 'waist', arabic: 'خَصْرٌ', hint: 'the narrow part of the body above the hips', visual: 'waist', level: 1, sentence: "She tied the belt around her waist." },
  // abraid: spelled this way in the manuscript (translation matches "abrade" —
  // to scrape/wear away); kept as-is since it's the spelling given.
  { word: 'abraid', arabic: 'يَخْدُشُ / يَبْلَى', hint: 'to scrape or wear away', visual: 'abraid', level: 1, sentence: "Rough rope can abraid the skin on your hands." },
  { word: 'afraid', arabic: 'خَائِفٌ', hint: 'feeling fear', visual: 'afraid', level: 1, sentence: "The little boy was afraid of the dark." },
  { word: 'attain', arabic: 'يَحْصُلُ عَلَى / يُحَقِّقُ', hint: 'to succeed in achieving something', visual: 'attain', level: 1, sentence: "She worked hard to attain her goals." },
  { word: 'braids', arabic: 'ضَفَائِرُ', hint: 'hair woven into interlocking strands', visual: 'braids', level: 1, sentence: "She wore her hair in two neat braids." },
  { word: 'braise', arabic: 'يَطْهُو عَلَى نَارٍ هَادِئَةٍ', hint: 'to cook slowly in a small amount of liquid', visual: 'braise', level: 1, sentence: "The chef will braise the beef for two hours." },
  { word: 'domain', arabic: 'مَجَالٌ / مِنْطَقَةٌ', hint: 'an area of knowledge, land, or control', visual: 'domain', level: 1, sentence: "Cooking is not really my domain." },
  { word: 'detail', arabic: 'تَفْصِيلٌ / يُفَصِّلُ', hint: 'a small, specific piece of information', visual: 'detail', level: 1, sentence: "She noticed every detail in the painting." },
  { word: 'detain', arabic: 'يَحْتَجِزُ / يَعْتَقِلُ', hint: 'to keep someone from leaving', visual: 'detain', level: 1, sentence: "Police may detain a suspect for questioning." },
  { word: 'obtain', arabic: 'يَحْصُلُ عَلَى', hint: 'to get or acquire something', visual: 'obtain', level: 1, sentence: "You must obtain a ticket before boarding." },
  { word: 'ordain', arabic: 'يُنَصِّبُ / يُقَرِّرُ رَسْمِيًّا', hint: 'to officially appoint someone, often a priest', visual: 'ordain', level: 1, sentence: "He was ordained as a minister last spring." },
  { word: 'praise', arabic: 'يَمْدَحُ / مَدْحٌ', hint: 'to express approval or admiration', visual: 'praise', level: 1, sentence: "The teacher gave praise for the good work." },
  { word: 'remain', arabic: 'يَبْقَى / يَظَلُّ', hint: 'to stay in the same place or state', visual: 'remain', level: 1, sentence: "Please remain seated until the bus stops." },
  { word: 'retain', arabic: 'يَحْتَفِظُ بِـ', hint: 'to keep or hold onto something', visual: 'retain', level: 1, sentence: "Try to retain what you learn in class." },
  { word: 'retail', arabic: 'بَيْعٌ بِالتَّجْزِئَةِ', hint: 'the selling of goods to customers', visual: 'retail', level: 1, sentence: "The shirt costs twenty dollars at retail." },
  { word: 'waiter', arabic: 'نَادِلٌ', hint: 'a man who serves food in a restaurant', visual: 'waiter', level: 1, sentence: "The waiter brought our food to the table." },
  { word: 'abstain', arabic: 'يَمْتَنِعُ', hint: 'to choose not to do something', visual: 'abstain', level: 1, sentence: "He decided to abstain from eating sweets." },
  { word: 'captain', arabic: 'قُبْطَانٌ', hint: 'the leader of a ship, plane, or team', visual: 'captain', level: 1, sentence: "The captain steered the ship through the storm." },
  { word: 'certain', arabic: 'مُتَأَكِّدٌ / مُحَدَّدٌ', hint: 'sure or without doubt', visual: 'certain', level: 1, sentence: "I am certain that we locked the door." },
  { word: 'contain', arabic: 'يَحْتَوِي', hint: 'to hold something inside', visual: 'contain', level: 1, sentence: "This box can contain a lot of toys." },
  { word: 'curtain', arabic: 'سِتَارَةٌ', hint: 'a piece of cloth that covers a window', visual: 'curtain', level: 1, sentence: "She pulled the curtain closed at night." },
  { word: 'disdain', arabic: 'ازْدِرَاءٌ / احْتِقَارٌ', hint: 'a feeling of strong dislike or scorn', visual: 'disdain', level: 1, sentence: "He looked at the mess with disdain." },
  { word: 'explain', arabic: 'يُفَسِّرُ / يَشْرَحُ', hint: 'to make something clear to someone', visual: 'explain', level: 1, sentence: "Can you explain how this game works?" },
  { word: 'prepaid', arabic: 'مُسْبَقُ الدَّفْعِ', hint: 'paid for in advance', visual: 'prepaid', level: 1, sentence: "We used a prepaid card for the trip." },
  { word: 'reclaim', arabic: 'يَسْتَعِيدُ', hint: 'to get something back', visual: 'reclaim', level: 1, sentence: "She went to reclaim her lost umbrella." },
  { word: 'remains', arabic: 'بَقَايَا / آثَارٌ', hint: 'what is left behind, such as ruins', visual: 'remains', level: 1, sentence: "Ancient remains were found beneath the temple." },
  { word: 'sustain', arabic: 'يُحَافِظُ عَلَى / يَدْعَمُ', hint: 'to keep something going over time', visual: 'sustain', level: 1, sentence: "Plants need water to sustain their growth." },
  { word: 'complain', arabic: 'يَشْكُو', hint: 'to say you are unhappy about something', visual: 'complain', level: 1, sentence: "Please don't complain about the weather." },
  { word: 'proclaim', arabic: 'يُعْلِنُ / يُصَرِّحُ', hint: 'to announce something publicly', visual: 'proclaim', level: 1, sentence: "The king will proclaim a new holiday." },
  { word: 'restrain', arabic: 'يُقَيِّدُ', hint: 'to hold something back or keep it under control', visual: 'restrain', level: 1, sentence: "She had to restrain her excitement." },
  { word: 'chainsaw', arabic: 'مِنْشَارٌ سِلْسِلِيٌّ', hint: 'a power tool used to cut through wood', visual: 'chainsaw', level: 1, sentence: "The worker used a chainsaw to cut the fallen tree." },
  { word: 'chairman', arabic: 'رَئِيسٌ', hint: 'the person who leads a meeting or company', visual: 'chairman', level: 1, sentence: "The chairman opened the meeting with a speech." },
  { word: 'maintain', arabic: 'يُحَافِظُ عَلَى / يُصْلِحُ', hint: 'to keep something in good condition', visual: 'maintain', level: 1, sentence: "It takes work to maintain a garden." },
