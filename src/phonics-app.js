const WORDS = [
  ...
  { word: 'lade', arabic: 'يُحَمِّلُ (سَفِينَةً)', hint: 'to load a ship with cargo', visual: 'lade', level: 1, image: 'src/assets/images/Long A/054-lade.png', sentence: "Workers began to lade the ship with boxes." },
