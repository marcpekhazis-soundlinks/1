const WORDS = [
  ...
  { word: 'cray', arabic: 'سمك الجراد البحري (كريفيش)', hint: 'short for crayfish, a small clawed water creature', visual: 'cray', level: 1 },
...
function imageSvg(type, label) {
  ...
  const drawings = {
    ...
    jay: '<circle cx="115" cy="80" r="30"/><path d="M143 82l32-10-6 20z"/><path d="M95 105c-28 18-35 60-5 90 32 32 90 25 108-15 14-30 2-62-28-75"/><path d="M118 122l58-18"/>',
    ...
    cray: '<ellipse cx="155" cy="130" rx="58" ry="30"/><path d="M100 122c-22-8-42 0-45 15-3 15 14 22 27 10"/><path d="M100 140c-22 8-42 15-45 30-3 15 17 18 27 3"/><path d="M213 115l32-18M213 145l32 18"/><path d="M132 98l-12-22M178 98l12-22"/>',
