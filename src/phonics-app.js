const WORDS = [
  { word: "bay", arabic: "خليج", hint: "a curve of ocean by land", visual: "bay", level: 1, archived: true },
  { word: "day", arabic: "يوم", hint: "sun-up time", visual: "day", level: 1, archived: true },
  { word: "hay", arabic: "تبن", hint: "dry grass", visual: "hay", level: 1, archived: true },
  { word: "jay", arabic: "طائر القيق", hint: "a colorful, noisy bird", visual: "jay", level: 1, archived: true },
  { word: "lay", arabic: "يضع / يستلقي", hint: "put down or rest", visual: "bed", level: 1, archived: true },
  { word: "may", arabic: "قد / شهر مايو", hint: "might, or the month May", visual: "calendar", level: 1, archived: true },
  { word: "pay", arabic: "يدفع", hint: "give money", visual: "pay", level: 1, archived: true },
  { word: "ray", arabic: "شعاع", hint: "a line of light", visual: "ray", level: 1, archived: true },
  { word: "say", arabic: "يقول", hint: "speak words", visual: "speech", level: 1, archived: true },
  { word: "way", arabic: "طريق / أسلوب", hint: "a path, or how something is done", visual: "road", level: 1, archived: true },
  { word: "away", arabic: "بعيدا / ذهب", hint: "gone, or not in this place", visual: "arrows", level: 1, archived: true },
  { word: "bray", arabic: "نهيق الحمار", hint: "the loud, harsh cry a donkey makes", visual: "bray", level: 1, archived: true },
  { word: "clay", arabic: "طين", hint: "soft, wet earth used for pottery", visual: "clay", level: 1, archived: true },
  { word: "fray", arabic: "مشاجرة / يتهرأ", hint: "a scuffle, or threads wearing loose at an edge", visual: "fray", level: 1, archived: true },
  { word: "gray", arabic: "رمادي", hint: "the color between black and white", visual: "gray", level: 1, archived: true },
  { word: "play", arabic: "يلعب", hint: "have fun or join a game", visual: "game", level: 1, archived: true },
  { word: "pray", arabic: "يصلي / يدعو", hint: "to speak to God", visual: "pray", level: 1, archived: true },
  { word: "slay", arabic: "يقتل / يذبح", hint: "to kill with a weapon", visual: "sword", level: 1, archived: true },
  { word: "stay", arabic: "يبقى", hint: "remain in one place", visual: "house", level: 1, archived: true },
  { word: "sway", arabic: "يتأرجح / يتمايل", hint: "to rock gently from side to side", visual: "sway", level: 1, archived: true },
  { word: "spray", arabic: "يرش", hint: "send out small drops", visual: "spray", level: 1, archived: true },
  { word: "tray", arabic: "صينية", hint: "a flat holder for food", visual: "tray", level: 1, archived: true },
  ...
  { word: "gade", arabic: "ذهب (كلمة قديمة)", hint: "an old dialect word for went, past tense of go", visual: "gade", level: 1, archived: true },
  { word: "gage", arabic: "رهن / تعهد", hint: "something given as a promise or pledge", visual: "gage", level: 1, archived: true },
  ...
  { word: "hame", arabic: "المنزل (كلمة اسكتلندية قديمة)", hint: "an old Scots dialect word for home", visual: "hame", level: 1, archived: true },
  ...
  { word: "always", arabic: "دائماً", hint: "all the time", visual: "infinity", level: 2, archived: true },
  { word: "runaway", arabic: "هارب", hint: "someone who escapes", visual: "runner", level: 2, archived: true },
  { word: "birthday", arabic: "يوم الميلاد", hint: "a yearly celebration", visual: "cake", level: 2, archived: true },
  { word: "causeway", arabic: "طريق مشهود / ممر مرتفع", hint: "a raised road over water", visual: "road", level: 2, archived: true },
  { word: "claymore", arabic: "سيف اسكتلندي / لغم مسطح", hint: "a large old sword", visual: "sword", level: 2, archived: true },
  { word: "daybreak", arabic: "بزوغ الفجر / شروق الشمس", hint: "first light in the morning", visual: "sunrise", level: 2, archived: true },
  { word: "dayshift", arabic: "وردية النهار", hint: "work time during the day", visual: "worker", level: 2, archived: true },
  { word: "display", arabic: "يعرض / عرض", hint: "show something clearly", visual: "display", level: 2, archived: true },
  { word: "doorstay", arabic: "مزلاجة الباب / دعامة الباب", hint: "a support that holds a door", visual: "door", level: 2, archived: true },
  { word: "fairplay", arabic: "لعب نزيه / نزاهة", hint: "playing by the rules", visual: "handshake", level: 2, archived: true },
  { word: "gateway", arabic: "بوابة / مدخل", hint: "an entrance", visual: "gate", level: 2, archived: true },
  { word: "haystack", arabic: "كدس التبن / رزمة قش", hint: "a pile of hay", visual: "haystack", level: 2, archived: true },
  { word: "overstay", arabic: "يبقى أكثر من المدة", hint: "stay too long", visual: "clock", level: 2, archived: true },
  { word: "playbook", arabic: "كتاب اللعب / خطة اللعب", hint: "a book of game plans", visual: "book", level: 2, archived: true },
  { word: "sideways", arabic: "إلى الجانب / جانبياً", hint: "to or from the side", visual: "arrows", level: 2, archived: true },
